...
public class ControladorBusquedaVuelos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            LocalDate fechaIda = LocalDate.parse(request.getParameter("fecha_ida"));
            LocalDate fechaVuelta = LocalDate.parse(request.getParameter("fecha_vuelta"));
            int viajeros = Integer.parseInt(request.getParameter("num_billetes"));
            CRUDVuelo viaje = new CRUDVuelo(conexion); 
            listaVuelosIda = viaje.obtenerVuelos(origen, destino, fechaIda);
            //listaVuelosIda = viaje.obtenerTodos();
            listaVuelosVuelta = viaje.obtenerVuelos(destino, origen, fechaVuelta);
