...
public class ControladorPago extends HttpServlet {
    ...
    protected void insertarCompra(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int identificadorVueloIda = Integer.parseInt(id_vueloIda);
        int identificadorVueloVuelta = Integer.parseInt(id_vueloVuelta);
        ...
        if (usuario == null) {
            ...
            if (crudCliente.inicioSesionValido(usuario)) {
                ...
                Compra compraUsuarioIda = new Compra(numeroCompraIda, dni, identificadorVueloIda, asientoIda,precioIda);
                Compra compraUsuarioVuelta = new Compra(numeroCompraVuelta, dni, identificadorVueloVuelta, asientoVuelta,precioVuelta);
